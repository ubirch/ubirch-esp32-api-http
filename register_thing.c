...
curl --location --request POST \
   'https://api.console.prod.ubirch.com/ubirch-web-ui/api/v1/devices/create?with_api_info=true' \
   --header 'Content-Type: application/json' \
   --header 'Authorization: Bearer <TOKEN>' \
   --data-raw '{"hwDeviceId":"<UUID>", "description":"ADD DESCRIPTION OF DEVICE HERE"}'
*/
